...
static const ULONG g_thunk_ordinals[XBOX_KERNEL_THUNK_TABLE_SIZE] = {
    184, 199, 217, 187, 233, 219, 236, 226, 211, 218,   /* 0-9 */
    198, 232, 200, 196, 190, 289, 202, 207, 178, 165,   /* 10-19 */
    164, 171, 301,  49, 215, 203,  40,  67,  69,  24,   /* 20-29 */
    356, 126, 127, 166, 180, 182, 179, 128,   5, 305,   /* 30-39 */
    156, 304, 294, 277, 250, 143, 246, 259, 124, 144,   /* 40-49 */
    231, 224, 302, 258, 255,  16, 225, 234,  99,  91,   /* 50-59 */
    161, 129,  65,  14, 145, 159, 113, 107,  74,  95,   /* 60-69 */
    169, 170, 149,  97, 269, 291,  17,  83,  87,  81,   /* 70-79 */
    359, 358, 125, 322, 360, 279, 327, 328,  44, 160,   /* 80-89 */
     47,  98, 109, 151, 173, 175, 119, 176,   1,   2,   /* 90-99 */
      3,   4,   8, 100, 168,  23,  15, 137, 153, 142,   /* 100-109 */
    139, 312,                                           /* 110-111 */
};
